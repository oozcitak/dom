...
export class DOMImplementationImpl implements DOMImplementationInternal {
  ...
  createHTMLDocument(title?: string): Document {
     ...
     */
    const htmlElement = this._algo.element.createAnElement(doc, 'html', Namespace.HTML)
     ...
     */
    const headElement = this._algo.element.createAnElement(doc, 'head', Namespace.HTML)
     ...
     */
    if (title !== undefined) {
      const titleElement = this._algo.element.createAnElement(doc, 'title', Namespace.HTML)
     ...
     * HTML namespace, to the html element created earlier.
     */
    const bodyElement = this._algo.element.createAnElement(doc, 'body', Namespace.HTML)
