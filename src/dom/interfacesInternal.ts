 ...
 */
export interface AbortSignalInternal extends AbortSignal, EventTargetInternal {
 ...
 */
export interface XMLDocumentInternal extends DocumentInternal, XMLDocument {
 ...
 */
export interface SlotInternal extends Slot, ElementInternal {
  _name: string
  _assignedNodes: SlotableInternal[]
}
...
export interface SlotableInternal extends Slotable {
  _name: string
  _assignedSlot: SlotInternal | null
}